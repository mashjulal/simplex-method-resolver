...
public class EquationTest {
    ...
    @Test
    public void getCoefficients_isCorrect() throws Exception {
    ...
    @Test
    public void setCoefficients_isCorrect() throws Exception {

    }

    @Test
    public void setValue_isCorrect() throws Exception {
